...
// Sets default values
AMetaActorEntity::AMetaActorEntity()
{
...
void AMetaActorEntity::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AMetaActorEntity::Tick(float DeltaTime)
{
...
void AMetaActorEntity::SetTargetPosition(FVector InPos)
{
