...
#include "MetaDataMgr.generated.h"
 ...
 */
UCLASS()
class METAMMO_API UMetaDataMgr : public UObject
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
		UMetaDataAsset* TotalData;

	static UMetaDataMgr* MgrInst;
};
