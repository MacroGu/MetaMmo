...
public:
	...
	virtual void rspAvatarList(const AVATAR_BRIEF_INFO_LIST& arg1, uint64 arg2) = 0; 
	virtual void rspCreateAvatar(uint32 arg1) = 0; 
	virtual void rspEnterGame(uint32 arg1) = 0; 
	virtual void rspRemoveAvatar(uint32 arg1) = 0; 
